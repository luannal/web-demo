...
<html lang="en">
  <head>
    ...
    <script src="{{ asset('public/lib/gmaps/gmaps.js') }}"></script>
    <script src="{{ asset('public/lib/chart.js/Chart.js') }}"></script>
  ...
  <body>
    ...
    <div class="kt-sideleft-header">
      <div class="kt-logo"><a href="index.html">QUẢN TRỊ TIN</a></div>
    ...
    <div class="kt-breadcrumb">
      <nav class="breadcrumb">
        <a class="breadcrumb-item" href="index.html">Quản Trị Tin</a>
